...
#2018-12-10 16:16
CUDA_VISIBLE_DEVICES=0,1,2 python run_classifier.py --bert_model "bert-base-uncased" --data_dir "./datas/" --task_name "all" --output_dir "./checkpoints/all" --do_train --train_batch_size 96 --eval_batch_size 64 --model_suffix "bert-base-uncased_Dec11" --num_train_epochs 50 --early_training_epoch_threshold 5 --log_step 500 --resume_path "./checkpoints/all_bert-base-uncased_Dec10_Epoch7.ckpt"
#2018-12-11 12:01
#python run_classifier.py --bert_model "bert-base-uncased" --data_dir "./datas/" --task_name "all" --output_dir "./checkpoints/all" --do_evaluate_sample --checkpoint_path "./checkpoints/all/all_bert-base-uncased_Epoch7.ckpt"
